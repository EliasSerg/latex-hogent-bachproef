...
De doelgroep van dit onderzoek bestaat uit kleinschalige organisaties en particulieren die actief
zijn in omgevingen met beperkte of onbetrouwbare internetconnectiviteit. Concreet gaat het om:

\begin{itemize}
  \item maritieme gebruikers die op zee varen en geen stabiele breedbandverbinding hebben;
  \item kleinere bedrijven die actief zijn in afgelegen regio's zonder vaste
        netwerkinfrastructuur;
  \item gemeentes die nood hebben aan een alternatief communicatiekanaal wanneer de reguliere
        infrastructuur uitvalt;
  \item particulieren die in afgelegen gebieden wonen zonder toegang tot een vaste
        breedbandverbinding;
  \item B-EARS (\textit{Belgian Emergency Amateur Radio Service}), de vrijwilligersorganisatie
        binnen de UBA die op vraag van officiële instanties -- zoals het Rode Kruis of een
        crisiscentrum -- noodcommunicatie verzorgt wanneer de gangbare kanalen
        wegvallen~\autocite{UBABEARS}.
\end{itemize}
...
het packet loss percentage, de verbindingsstabiliteit en de maximale operationele afstand. Deze
laatste wordt niet als een enkele, harde grens benaderd, maar als een reeks afstandscategorieën
waarbinnen de haalbare prestaties afzonderlijk worden gekwantificeerd -- zodat het antwoord op de
onderzoeksvraag genuanceerd kan zijn ("tot waar werkt dit goed, en vanaf waar niet meer") in
plaats van louter bevestigend of ontkennend.

\begin{figure}[h]
  \centering
  \includegraphics[width=\textwidth]{verbinding.png}
  \caption{Beoogde opstelling punt-tot-punt radioverbinding}
...
In Hoofdstuk~\ref{ch:requirementsanalyse} worden de functionele en niet-functionele eisen
waaraan de proof-of-concept moet voldoen expliciet vastgelegd, en wordt op basis daarvan de
systeemarchitectuur -- de combinatie van frequentieband en bestandsoverdrachtsprotocol --
onderbouwd geselecteerd.

In Hoofdstuk~\ref{ch:proof-of-concept} wordt de praktische realisatie van deze architectuur
beschreven: een volledig geautomatiseerde, virtuele testomgeving die de fysieke
straalverbinding nabootst, met bijzondere aandacht voor de manier waarop wisselende
weersomstandigheden en de wettelijk verplichte Dynamic Frequency Selection (Sectie~\ref{subsec:dfs})
op een realistische, statistische wijze gesimuleerd worden.

In Hoofdstuk~\ref{ch:resultaten-en-evaluatie} worden de meetresultaten van deze proof-of-concept
gepresenteerd en getoetst aan de requirements uit Hoofdstuk~\ref{ch:requirementsanalyse}, telkens
afzonderlijk per afstandscategorie.
