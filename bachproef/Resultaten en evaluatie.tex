...
Sectie~\ref{sec:res-methodologie}. Figuur~\ref{fig:packetloss-per-afstand} toont
...
\begin{figure}[h]
  \centering
  \includegraphics[width=\textwidth]{figs/packetloss_per_afstand.pdf}
  ...
  \label{fig:packetloss-per-afstand}
\end{figure}
