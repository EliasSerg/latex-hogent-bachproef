...
\lstinputlisting[language=yaml, basicstyle=\small\ttfamily, caption={cloud-init/server-user-data.yaml}, label={lst:app-cloudinit-server}]
  {code/scripts/poc-scripts-windows/cloud-init/server-user-data.yaml}
\lstinputlisting[language=yaml, basicstyle=\small\ttfamily, caption={cloud-init/link-emulator-user-data.yaml}, label={lst:app-cloudinit-linkemu}]
  {code/scripts/poc-scripts-windows/cloud-init/link-emulator-user-data.yaml}
\lstinputlisting[language=yaml, basicstyle=\small\ttfamily, caption={cloud-init/client-user-data.yaml}, label={lst:app-cloudinit-client}]
