...
komen de connectiviteitsproblematiek in afgelegen gebieden en noodsituaties, de fysische
eigenschappen van radiofrequenties en signaalpropagatie, multiplextechnieken,
protocollen voor radiogebaseerde dataoverdracht, en de toepassing van straalverbindingen
aan bod. Tot slot worden de wettelijke randvoorwaarden voor radioamateurs in België
besproken. Dit theoretisch kader vormt de basis voor de methodologie en de
proof-of-concept die in de volgende hoofdstukken worden uitgewerkt.
...
ruggengraat voor noodcommunicatie~\autocite{WinlinkEmcomm}.

\section{Radiofrequenties en signaalpropagatie}
\label{sec:Radiofrequenties en signaalpropagatie}

\section{Multiplextechnieken in radiogebaseerde datacommunicatie}
\label{sec:Multiplextechnieken in radiogebaseerde datacommunicatie}

\section{Protocollen voor radiogebaseerde
dataoverdracht}
\label{sec:Protocollen voor radiogebaseerde
dataoverdracht}

\section{Straalverbindingen als proof-of-concept}
